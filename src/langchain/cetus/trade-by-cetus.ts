...
export class SuiCetusTradeTool extends Tool {
    name = "sui_cetus_trade";
    ...
    protected async _call(input: string): Promise<string> {
      try {
        ...
        const tx = await this.suiAgentKit.tradeByCetus(parsedInput.target, parsedInput.amount, parsedInput.from, parsedInput.byAmountIn);
